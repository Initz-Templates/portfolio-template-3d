  ...
  return (
    <Section>
      ...
      <div className="social-icons">
        <a href="https://www.linkedin.com/company/initializ" target="_blank">
      ...
      <h1> 
        ...
        <span className="px-1" style={{ fontFamily: 'Calligraphy', fontSize: '70px' }}>
          <span className="font-bold" style={{fontFamily: 'Calligraphy'}}>Portfolio Template</span>
        </span>
      </h1>
      <motion.p
      ...
      >
        <span className="font-custom" style={{ fontFamily: 'Roman', fontSize: '25px' }}>
          ...
          Career Headline
          <br />
          Graduation/PG Details
          <br />
          Certification Details
          <br />
          Hobies and Other Interests
          </span>
